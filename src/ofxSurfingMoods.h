...
/*
	...
	+ fix vert slider coloring when standalone
		+ make theme dark & light to change border color.
...
private:
	...
	// Toggles index / selectors

	surfingParamIndexToggles toggles_Target;
	surfingParamIndexToggles toggles_PresetA;
	surfingParamIndexToggles toggles_PresetB;
	surfingParamIndexToggles toggles_PresetC;

public:

	ofParameterGroup& getTogglesTarget() { return toggles_Target.getParamToggles(); }
	ofParameterGroup& getTogglesPresetA() { return toggles_PresetA.getParamToggles(); }
	ofParameterGroup& getTogglesPresetB() { return toggles_PresetB.getParamToggles(); }
	ofParameterGroup& getTogglesPresetC() { return toggles_PresetC.getParamToggles(); }
};
